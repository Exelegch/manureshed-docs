...
#> 
#> Processing year2010...
#> Downloading nugis_huc8_data from OSF...
#>   File ID: 689a80e66880a2c5318935f0
#>   Downloaded successfully (1.4 MB)
#> Loaded NuGIS huc8 data for year 2010
#> Number of spatial units: 2111
#> Downloading huc8_boundaries from OSF...
#>   File ID: 689a80de8688b85a3e893403
#>   Downloaded successfully (4.06 MB)
...
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2010/huc8_agricultural_2010.rds
#> File size: 7.11 MB
#> Rows: 2132, Columns: 17
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2010/huc8_nitrogen_integrated_2010.rds
#> File size: 7.15 MB
#> Rows: 2132, Columns: 23
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved centroid data to: /tmp/Rtmp0PyVRG/year_2010/huc8_nitrogen_centroids_2010.csv
#> File size: 562.83 KB
#> Rows: 2132, Columns: 24
#> Longitude range: [-124.345, -67.71]
#> Latitude range: [25.201, 48.988]
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_2010/analysis_summary_2010.rds
#> Format: RDS
#> File size: 0.71 KB
...
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2011/huc8_agricultural_2011.rds
#> File size: 7.11 MB
#> Rows: 2132, Columns: 17
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2011/huc8_nitrogen_integrated_2011.rds
#> File size: 7.15 MB
#> Rows: 2132, Columns: 23
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved centroid data to: /tmp/Rtmp0PyVRG/year_2011/huc8_nitrogen_centroids_2011.csv
#> File size: 564.35 KB
#> Rows: 2132, Columns: 24
#> Longitude range: [-124.345, -67.71]
#> Latitude range: [25.201, 48.988]
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_2011/analysis_summary_2011.rds
#> Format: RDS
#> File size: 0.72 KB
...
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2012/huc8_agricultural_2012.rds
#> File size: 7.11 MB
#> Rows: 2132, Columns: 17
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2012/huc8_nitrogen_integrated_2012.rds
#> File size: 7.15 MB
#> Rows: 2132, Columns: 23
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved centroid data to: /tmp/Rtmp0PyVRG/year_2012/huc8_nitrogen_centroids_2012.csv
#> File size: 565.04 KB
#> Rows: 2132, Columns: 24
#> Longitude range: [-124.345, -67.71]
#> Latitude range: [25.201, 48.988]
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_2012/analysis_summary_2012.rds
#> Format: RDS
#> File size: 0.72 KB
#>   Year2012complete (2132 units)
#> 
#> Creating comparative visualizations...
#> Saved plot to: /tmp/Rtmp0PyVRG/trend_nitrogen_2010_2012.png
...
#> Number of spatial units: 3064
#> Downloading county_boundaries from OSF...
#>   File ID: 689a80dbfcf05a1374a5ea29
#>   Downloaded successfully (0.64 MB)
...
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_1990/county_agricultural_1990.rds
#> File size: 1.03 MB
#> Rows: 3112, Columns: 17
#> Geometry type: POLYGON
#> CRS: EPSG:5070
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_1990/analysis_summary_1990.rds
#> Format: RDS
#> File size: 0.5 KB
...
#> Agricultural classification complete!
#> Applied threshold: 1235.53 acres
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_1991/county_agricultural_1991.rds
#> File size: 1.04 MB
#> Rows: 3112, Columns: 17
#> Geometry type: POLYGON
#> CRS: EPSG:5070
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_1991/analysis_summary_1991.rds
#> Format: RDS
#> File size: 0.5 KB
...
#> Agricultural classification complete!
#> Applied threshold: 1235.53 acres
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_1992/county_agricultural_1992.rds
#> File size: 1.03 MB
#> Rows: 3112, Columns: 17
#> Geometry type: POLYGON
#> CRS: EPSG:5070
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_1992/analysis_summary_1992.rds
#> Format: RDS
#> File size: 0.5 KB
#>   Year1992complete (3112 units)
#> 
#> Creating comparative visualizations...
#> Saved plot to: /tmp/Rtmp0PyVRG/trend_nitrogen_1990_1992.png
#> Dimensions: 12 x 8 in at 300 DPI
#> File size: 126.65 KB
#> Device: png
#>   Creatednitrogentrend plot
#> Saved plot to: /tmp/Rtmp0PyVRG/trend_phosphorus_1990_1992.png
#> Dimensions: 12 x 8 in at 300 DPI
#> File size: 142.95 KB
#> Device: png
...
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2005/huc8_agricultural_2005.rds
#> File size: 7.11 MB
#> Rows: 2132, Columns: 17
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_2005/analysis_summary_2005.rds
#> Format: RDS
#> File size: 0.52 KB
...
#>   Total nitrogen load: 1141912.73 tons/year
#> Integrating WWTP nitrogen data with agricultural classifications...
#> Using agricultural ID column: huc8
#> Combined nitrogen classification summary:
#>   Excluded: 115 units
...
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2015/huc8_agricultural_2015.rds
#> File size: 7.11 MB
#> Rows: 2132, Columns: 17
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved spatial data to: /tmp/Rtmp0PyVRG/year_2015/huc8_nitrogen_integrated_2015.rds
#> File size: 7.15 MB
#> Rows: 2132, Columns: 23
#> Geometry type: MULTIPOLYGON
#> CRS: EPSG:5070
#> Saved centroid data to: /tmp/Rtmp0PyVRG/year_2015/huc8_nitrogen_centroids_2015.csv
#> File size: 564.86 KB
#> Rows: 2132, Columns: 24
#> Longitude range: [-124.345, -67.71]
#> Latitude range: [25.201, 48.988]
#> Saved analysis summary to: /tmp/Rtmp0PyVRG/year_2015/analysis_summary_2015.rds
#> Format: RDS
#> File size: 0.72 KB
#>   Year2015complete (2132 units)
#> 
#> Creating comparative visualizations...
#> Saved plot to: /tmp/Rtmp0PyVRG/trend_nitrogen_2005_2015.png
#> Dimensions: 12 x 8 in at 300 DPI
#> File size: 115.06 KB
#> Device: png
#>   Creatednitrogentrend plot
