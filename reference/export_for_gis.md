...
#> Warning: GDAL Error 1: /tmp/RtmpqiKSvl/gis_outputs/agricultural_results.shp does not appear to be a file or directory.
#> Created shapefile: /tmp/RtmpqiKSvl/gis_outputs/agricultural_results.shp
#> Created GeoJSON: /tmp/RtmpqiKSvl/gis_outputs/agricultural_results.geojson
#> Warning: Field names abbreviated for ESRI Shapefile driver
#> Warning: GDAL Error 1: /tmp/RtmpqiKSvl/gis_outputs/nitrogen_integrated.shp does not appear to be a file or directory.
#> Warning: Field names abbreviated for ESRI Shapefile driver
#> Warning: GDAL Error 1: /tmp/RtmpqiKSvl/gis_outputs/phosphorus_integrated.shp does not appear to be a file or directory.
# }
```
