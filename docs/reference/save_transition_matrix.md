...
#> ======================================
#> 
#> created_date:2026-01-25 20:49:52.229607
#> nutrient:nitrogen
#> analysis_type:combined
#> n_categories:4
#> categories:
...
#>   Source
#>   Within_County
#> Saved transition matrix to: /tmp/RtmpNpFMAi/transitions_nitrogen.csv
#> Saved metadata to: /tmp/RtmpNpFMAi/transitions_nitrogen_metadata.txt
#> File size: 0.19 KB
#> Matrix dimensions: 4 x 4
#> [1] "/tmp/RtmpNpFMAi/transitions_nitrogen.csv"
# }
```
