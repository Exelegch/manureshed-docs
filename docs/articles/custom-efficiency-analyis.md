...
This vignette demonstrates how to conduct sensitivity analysis using
...
assumptions affect classification results.

## Standard vs. Custom Efficiency Factors

**Standard Factors:** - **Nitrogen: 0.5 (50%)** - Reflects typical
losses during nutrient cycling, application, and uptake - **Phosphorus:
1.0 (100%)** - Assumes full phosphorus availability

**When to Use Custom Factors:** - Evaluating improved management
practices (higher efficiency) - Accounting for regional differences in
application methods - Conducting uncertainty analysis - Testing
...
While phosphorus typically uses 100% efficiency, you can explore
...
1.  **Source Watersheds:** Higher efficiency factors typically increase
    the number of source watersheds as more nitrogen becomes “available”
    for redistribution

2.  **Sink Classification:** Lower efficiencies may shift some “within
    watershed” areas to deficit status
...
4.  **Uncertainty Quantification:** Range of results across scenarios
    indicates uncertainty due to efficiency assumptions

## Recommended Practice

For publication or policy analysis, consider:

1.  **Report standard results** using established efficiency factors
    (0.5 for N, 1.0 for P)
2.  **Conduct sensitivity analysis** with reasonable alternative values
    (e.g., Â±20%)
...
Custom efficiency factors enable: - **Sensitivity analysis** to quantify
uncertainty - **Scenario planning** for different management practices  
- **Regional adaptation** for varying agricultural systems - **Policy
evaluation** under different assumptions

For most applications, standard factors (N: 0.5, P: 1.0) remain
appropriate, but sensitivity analysis provides valuable context for
interpreting results and informing decision-making.

## References

- Spiegal et al. (2020). Manuresheds: Advancing nutrient recycling in US
  agriculture
- Flynn et al. (2023). Manureshed nutrient balances at watershed scales
- Akanbi et al. (2025). Towards circular nutrient economies: Integrated
  framework
