...
The package excludes areas with little cropland from analysis. The
...
For HUC8 and HUC2 scales, the package calculates thresholds
...
This covers the main advanced features. The package is designed to be
flexible for power users while remaining accessible for basic analyses.
