...
utils::globalVariables(c(
  ...
  # Hub site selection (hub_functions.R)
  ".data", "STATEFP", "X", "Y",
  "State_Name", "score_id", "nutrient", "idx",
  "n_scores_in_top", "best_rank",
  "cdl_N_suitability", "cdl_P_suitability",
  "N_deficit_raw", "P_deficit_raw",
  "N_demand_refined", "P_demand_refined",
  "ag_N_supply", "ag_P_supply",
  "wwtp_N_supply", "wwtp_P_supply",
  "combined_N_supply", "combined_P_supply",
  "wwtp_n_count", "wwtp_p_count",
  "cafo_count", "transport_centrality",
  "demand_N_catchment", "demand_P_catchment",
